...
namespace mujoco
{
    ...
    public:
        ...
        // one-off preparation before starting to render (e.g., memory
        // allocation)
        void InitializeRenderLoop();

        // loop to render the UI (must be called from main thread because of
        // MacOS)
        void RenderLoop();
        ...
        // Constant arrays needed for the option section of UI and the UI
        // interface
