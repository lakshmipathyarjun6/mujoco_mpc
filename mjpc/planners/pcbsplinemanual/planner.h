#ifndef MJPC_PLANNERS_PC_BSPLINE_MANUAL_PLANNER_H_
#define MJPC_PLANNERS_PC_BSPLINE_MANUAL_PLANNER_H_
...
namespace mjpc
{
    class PCBSplineManualPlanner : public Planner
    {
    public:
        // constructor
        PCBSplineManualPlanner() = default;

        // destructor
        ~PCBSplineManualPlanner() override = default;
    ...
    private:
        ...
        // policies
        PCBSplineManualPolicy m_active_policy; // (Guarded by mtx_)
...
#endif // MJPC_PLANNERS_PC_BSPLINE_MANUAL_PLANNER_H_
