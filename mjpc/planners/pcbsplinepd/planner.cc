...
namespace mjpc
{
    ...
    void PCBSplinePDPlanner::Initialize(mjModel *model, const Task &task)
    {
    ...
    // allocate memory
    void PCBSplinePDPlanner::Allocate()
    {
        // initial state
    ...
    void PCBSplinePDPlanner::Reset(int horizon,
    ...
    void PCBSplinePDPlanner::OptimizePolicy(int horizon, ThreadPool &pool)
    {
        // Do bsplinepd
    }

    // compute trajectory using nominal policy
    void PCBSplinePDPlanner::NominalTrajectory(int horizon, ThreadPool &pool)
    {
        // set policy
    ...
    void PCBSplinePDPlanner::ActionFromPolicy(double *action,
    ...
    const Trajectory *PCBSplinePDPlanner::BestTrajectory()
    {
        return &m_trajectory;
    }

    // set state
    void PCBSplinePDPlanner::SetState(const State &state)
    {
    ...
    void PCBSplinePDPlanner::Traces(mjvScene *scn) {}
    ...
    void PCBSplinePDPlanner::Plots(mjvFigure *fig_planner, mjvFigure *fig_timer,
