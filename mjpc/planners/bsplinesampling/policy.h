#ifndef MJPC_PLANNERS_BSPLINE_SAMPLING_POLICY_H_
#define MJPC_PLANNERS_BSPLINE_SAMPLING_POLICY_H_
...
namespace mjpc
{
    ...
    class BSplineSamplingPolicy : public Policy
    {
    public:
        // constructor
        BSplineSamplingPolicy() = default;

        // destructor
        ~BSplineSamplingPolicy() override = default;
        ...
        void CopyControlPointsFrom(const BSplineSamplingPolicy &policy);
...
#endif // MJPC_PLANNERS_BSPLINE_SAMPLING_POLICY_H_
