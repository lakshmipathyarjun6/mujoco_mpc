#ifndef MJPC_PLANNERS_PC_BSPLINE_SAMPLING_POLICY_H_
#define MJPC_PLANNERS_PC_BSPLINE_SAMPLING_POLICY_H_
...
namespace mjpc
{
    ...
    class PCBSplineSamplingPolicy : public Policy
    {
    public:
        // constructor
        PCBSplineSamplingPolicy() = default;

        // destructor
        ~PCBSplineSamplingPolicy() override = default;
        ...
        // used
        void AdjustPCComponentMatrix(int numActivePCs);

        // copy bspline control points
        void CopyControlPointsAndActivePCsFrom(
...
#endif // MJPC_PLANNERS_PC_BSPLINE_SAMPLING_POLICY_H_
