#ifndef MJPC_PLANNERS_PC_BSPLINE_SAMPLING_PLANNER_H_
#define MJPC_PLANNERS_PC_BSPLINE_SAMPLING_PLANNER_H_
...
namespace mjpc
{
    class PCBSplineSamplingPlanner : public RankedPlanner
    {
    public:
        // constructor
        PCBSplineSamplingPlanner() = default;

        // destructor
        ~PCBSplineSamplingPlanner() override = default;
        ...
        int NumParameters() override { return 4 * m_num_active_pcs; };
    ...
    private:
        ...
        // policies
        PCBSplineSamplingPolicy m_active_policy; // (Guarded by mtx_)
        PCBSplineSamplingPolicy m_candidate_policies[kMaxTrajectory];
        PCBSplineSamplingPolicy m_previous_policy;
...
#endif // MJPC_PLANNERS_PC_BSPLINE_SAMPLING_PLANNER_H_
